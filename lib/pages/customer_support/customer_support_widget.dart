              ...
              children: [
                              ...
                              builder: (context, snapshot) {
                                ...
                                if (customerServiceColumnSupportMesagesRecordList
                                  ...
                                  return EmptyWidget(
                                    title: 'Chat Support!',
                                    body:
                                        'Send your concern, we are gald to help',
                                    customAction: () async {},
                                  );
                                }
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            Stack(
                                                                          children: [
                                                                            if (customerServiceColumnSupportMesagesRecord.video != null &&
                                                                                customerServiceColumnSupportMesagesRecord.video != '')
                                                                              Container(
                                                                                width: double.infinity,
                                                                                height: double.infinity,
                                                                                decoration: BoxDecoration(
                                                                            ...
                                                                            if (customerServiceColumnSupportMesagesRecord.audio != null &&
                                                                            ...
                                                                            if (customerServiceColumnSupportMesagesRecord.image != null &&
                                                                                customerServiceColumnSupportMesagesRecord.image != '')
                                                                              InkWell(
                ...
                if (_model.attachMenu)
                  Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 23.0, 58.0),
                      child: Column(
                ...
                if (_model.hasAttachment)
                  Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 0.0, 58.0),
                      child: ClipRRect(
