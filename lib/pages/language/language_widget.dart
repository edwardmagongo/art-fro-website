                                ...
                                child: wrapWithModel(
                                  ...
                                  child: LanguagesItemWidget(
                                    ...
                                    text: FFLocalizations.of(context)
                                        .getVariableText(
                                      enText: 'English (US)',
                                      esText: ' Inglés (Estados Unidos)',
                                      frText: ' Anglais (États-Unis)',
                                      arText: 'الإنجليزية (الولايات المتحدة)',
                                      swText: 'Kiingereza (Marekani)',
                                    ),
                                  ),
                                ),
                              ),
                                ...
                                child: wrapWithModel(
                                  ...
                                  child: LanguagesItemWidget(
                                    ...
                                    text: FFLocalizations.of(context)
                                      ...
                                      esText: 'Español (ES)',
                                      frText: ' Espagnol (ES)',
                                      arText: 'الإسبانية (إسبانيا)',
                                      swText: ' Kihispania (ES)',
                                    ),
                                  ),
                                ),
                              ),
